...
import 'package:flutter_calculator/theme_color.dart';
import 'package:flutter_calculator/theme_extension.dart';
...
class _CalculatorNeuAppState extends State<CalculatorNeuApp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: darkMode ? context.primaryColorDark : context.primaryColorLight,
      body: LayoutBuilder(
    ...
    return Listener(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: darkMode ? context.primaryColorDark : context.primaryColorLight,
